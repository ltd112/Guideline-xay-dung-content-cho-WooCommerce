# Hướng dẫn cấu hình Theme Flatsome
...
## 5. Giải pháp Tối ưu Menu vượt qua khung hình bằng Mega Menu trong Flatsome

Khi cấu trúc điều hướng danh mục quá dài, việc hiển thị trên Desktop sẽ gây ra lỗi hiển thị không hết menu hoặc tràn giao diện theo chiều dọc. Để tối ưu, quy trình kỹ thuật chuẩn yêu cầu tách biệt hệ thống thành 2 menu riêng biệt:
