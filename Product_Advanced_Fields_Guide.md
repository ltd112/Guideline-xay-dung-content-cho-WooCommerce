# Hướng dẫn Sử dụng Plugin WooCommerce Product Advanced Fields

> [!NOTE]
> **WooCommerce Product Advanced Fields** là một plugin độc lập mạnh mẽ giúp người quản trị tạo và quản lý linh hoạt các nhóm trường dữ liệu tùy chỉnh (Custom Fields) cho sản phẩm (Ví dụ: SKU phụ, thông số kỹ thuật chi tiết, ghi chú bảo hành, hướng dẫn sử dụng riêng...). 

---

## 1. Truy cập & Quản lý Danh sách Nhóm trường
Để bắt đầu quản lý các nhóm trường nâng cao cho sản phẩm:
- Truy cập vào menu quản trị: **Products -> Advanced Fields**.
...
<div align="center">
    <img src="images/plugin/wc-product-advanced-fields/plugin_product_advanced_field_list.png" alt="Danh sách Product Advanced Fields" />
</div>

---

## 2. Cấu hình Chi tiết Nhóm trường (Advanced Field Settings)
Khi bạn thực hiện tạo mới (**Add New**) hoặc chỉnh sửa một nhóm trường, giao diện cấu hình sẽ được chia thành **3 Tab chính** chuyên nghiệp:
...
<div align="center">
    <img src="images/plugin/wc-product-advanced-fields/plugin_product_advanced_field_group_setting.png" alt="Cấu hình Group Setting" />
</div>
...
<div align="center">
    <img src="images/plugin/wc-product-advanced-fields/plugin_product_advanced_field_fields.png" alt="Cấu hình Fields" />
</div>
...
- **Quy tắc bộ lọc (Rules)**: Hỗ trợ tạo các điều kiện hiển thị tự động dựa trên:
  * **Product**: Chỉ áp dụng cho một hoặc một vài sản phẩm được chỉ định đích danh.
  * **Category**: Áp dụng cho toàn bộ các sản phẩm thuộc một danh mục cụ thể (Ví dụ: Chỉ hiện trường *Kích thước màn hình* khi sản phẩm thuộc danh mục *Điện thoại*).
  * **Attribute**: Áp dụng cho các sản phẩm có chứa thuộc tính cụ thể.

<div align="center">
    <img src="images/plugin/wc-product-advanced-fields/plugin_product_advanced_field_display_rule.png" alt="Cấu hình Display Rule" />
</div>
