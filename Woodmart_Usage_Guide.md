...
- **Kiến trúc Container**:
    ...
    <img src="images/woodmart/woodmart_container.png" alt="Kiến trúc Container Woodmart" />
    ...
    <img src="images/woodmart/woodmart_container_min_height.png" alt="Thiết lập Min Height cho Container" />
...
- **Widget tiêu chuẩn**:
    ...
    <img src="images/woodmart/woodmart_element_collection_product.png" alt="Widget Collection Product Woodmart" />
- **Hệ thống Layouts**:
...
- **Tính năng chủ chốt**: 
    ...
    <img src="images/woodmart/woodmart_header.png" alt="Giao diện Woodmart Header Builder" />
...
- **Swatch Styling**: Cấu hình **CSS** (Background/Text Color) cho trạng thái **Selected** tại phần Swatch Settings.
    <img src="images\plugin\plugin_variant_display.png" alt="Cấu hình hiển thị biến thể trong Woodmart" />
...
1. **Cấu hình cấp Thuộc tính (Global settings)**:
    ...
    <img src="images/woodmart/woodmart_attribute_swatch.png" alt="Cấu hình Attribute Swatch trong Woodmart" />
...
2. **Cấu hình giá trị hiển thị (Configure Terms)**:
    ...
    <img src="images/woodmart/woodmart_attribute_value_swatch.png" alt="Cấu hình giá trị Swatch chi tiết" />
